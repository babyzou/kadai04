//section 1
//APIを利用する際のURL
let KEY = 'AIzaSyCp8WdN7KtHg9BCW6lX4blp8Kmgnfvs2to'
...
// 翻訳
//vision APIで戻ってきた値をtranslation APIに渡す
/*let text = showResult("resultBox");
let fromLang = 'en'
let toLang = 'ja'

const URL = "https://translation.googleapis.com/language/translate/v2?key="+"AIzaSyA9uuAWYLYA2yZ3VXD2kVn5Rf7qfekYtGI"+
...
//ゴールから逆算してコードを因数分解する、順次、繰り返し、条件処理